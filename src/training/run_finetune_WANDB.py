...
from sklearn.metrics import confusion_matrix, accuracy_score, f1_score,  precision_score, recall_score, roc_auc_score #added
import datetime
import time
import numpy as np
import torch
...
def main():
    ...
    # input()
    # Login to WandB
    wandb.login(key='c675b7543d226e4793afffd0ec11bbb723aec767')
    
    ## Initialize WANDB
    wandb.init(
		# set the wandb project where this run will be logged
		project= args.architecture+"_Work",
        entity="rekha-sathian",
